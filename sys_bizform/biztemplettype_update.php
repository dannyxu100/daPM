...
<html xmlns="http://www.w3.org/1999/xhtml">
 <HEAD>
	...
	<style type="text/css">
		...
		#bft_remark{width:400px; height:120px;}
	</style>
 </HEAD>
<BODY>
<div>
	<div class="righttitle">表单类型基本信息 <a style="margin-left:320px;" href="javascript:void(0)" onclick="updatebft()" >保存</a></div>
	
	<table id="orgform" class="tableform" style="width:100%">
		<tr>
			<td colspan="3">名称 <input id="bft_name" type="text" value="" /></td>
		</tr>
		<tr>
			<td style="width:130px;">编号 <input id="bft_id" type="text" style="width:50px;" disabled="true" value=""/></td>
			<td style="width:130px;">排序 <input id="bft_sort" type="text" style="width:50px;" value=""/></td>
			<td>日期 <input id="bft_date" type="text" value="" /></td>
		</tr>
		<tr>
			<td colspan="3" style="vertical-align:top;">备注 <textarea id="bft_remark" ></textarea></td>
		</tr>
	</table>
</div>
</BODY>
