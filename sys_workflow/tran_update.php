...
<BODY>
	...
	<table class="tablesolid" style="width:100%">
		...
		<tr>
			...
			<td><input id="t_rolename" disabled="true" /><input type="hidden" id="t_roleid" /><input type="button" id="" value="选择" /></td>
		</tr>
		<tr>
...
<script type="text/javascript" src="js/tran_update.js"></script>
