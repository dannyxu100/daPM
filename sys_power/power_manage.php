 ...
 <HEAD>
  <TITLE>权限管理</TITLE>
	...
	<style type="text/css">
		...
		#pp_remark{width:400px; height:120px;}
	</style>
 </HEAD>
<BODY>
<div>
			...
			<td style="vertical-align:top;">
				<div class="list_top_bar">
					...
					<div class="list_top_tools">
						<a class="item" href="javascript:void(0)" onclick="updatepower();" ><img src="/images/sys_icon/save.png" /> 保存</a>
					</div>
				</div>
				
				<table id="orgform" class="tableform" style="width:100%">
					<tr>
						<td colspan="3">名称 <input id="pp_name" type="text" style="width:400px;" value="" /></td>
					</tr>
					<tr>
						<td colspan="3">代码 <input id="pp_code" type="text" value="" /></td>
					</tr>
					<tr>
						<td style="width:130px;">编号 <input id="pp_id" type="text" style="width:50px;" disabled="true" value=""/></td>
						<td style="width:130px;">排序 <input id="pp_sort" type="text" style="width:50px;" value=""/></td>
						<td>日期 <input id="pp_date" type="text" value="" /></td>
					</tr>
					<tr>
						<td colspan="3" style="vertical-align:top;">备注 <textarea id="pp_remark" ></textarea></td>
					</tr>
				</table>
			</td>
		</tr>
...
<script type="text/javascript" src="js/power_manage.js"></script>
