...
function loadtab(){
	...
	daTab0.appendItem("item01","联系提醒","/images/sys_icon/error.png",{
		click:function(){
		
		}
	});

	daTab0.appendItem("item02","近日跟踪","/images/sys_icon/message.png",{
		click:function(){
		
		}
	});
	
	daTab0.appendItem("item03","星标客户","/images/sys_icon/ok.png",{
		click:function(){
