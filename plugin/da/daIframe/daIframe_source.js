	...
	*/
	daIframe.createPointer = function(){
		...
		*/
		...
		daIframe.pagePointer.left.style.cssText = daIframe.pagePointer.right.style.cssText = "position:absolute; top:45%; width:48px;height:48px;background:url(/image/daIframe_pagePointer.png);display:none;";
